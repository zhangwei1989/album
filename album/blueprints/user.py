...
from album.emails import send_confirm_email
from album.models import User, Photo, Collect
from album.notifications import push_follow_notification
from album.utils import redirect_back
from album.settings import Operations
from album.forms.user import EditProfileForm, UploadAvatarForm, CropAvatarForm, ChangeEmailForm, \
    ChangePasswordForm, NotificationSettingForm, PrivacySettingForm, DeleteAccountForm
from album.utils import generate_token, validate_token, redirect_back, flash_errors
